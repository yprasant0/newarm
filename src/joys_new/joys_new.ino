...
geometry_msgs::Quaternion joy_msg3;
ros::Publisher pub_joy3("joystick3", &joy_msg3);
...
if((analogRead(A1)>=980)&&(analogRead(A1)<=1023))
{
 if(a1<=3.14){
  a1 = a1 + 0.01;
 } 
...
if((analogRead(A0)>=980)&&(analogRead(A0)<=1023))
{
 if(b1<=0.78){
  b1 = b1 + 0.01;
 } 
...
if((analogRead(A2)>=980)&&(analogRead(A2)<=1023))
{
 if(c1<=1.30){
  c1 = c1 + 0.01;
 } 
...
if((analogRead(A4)>=980)&&(analogRead(A4)<=1023))
{
 if(a2<=1.57){
  a2 = a2 + 0.01;
 } 
...
if((analogRead(A3)>=980)&&(analogRead(A3)<=1023))
{
 if(b2<=1.57){
  b2 = b2 + 0.01;
 } 
...
if((analogRead(A5)>=980)&&(analogRead(A5)<=1023))
{
 if(c2<=1.57){
  c2 = c2 + 0.01;
 } 
